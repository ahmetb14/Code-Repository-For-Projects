...
public interface JobAdvertisementDao extends JpaRepository<JobAdvertisement, Integer> {
	...
	@Query(value = "Select * From job_advertisements where is_confirmed_by_admin = true and is_active = true ", countQuery = "Select count(*) From job_advertisements where is_confirmed_by_admin = true and is_active = true ", nativeQuery = true)
